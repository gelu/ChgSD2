DELETE FROM `script_texts` WHERE `comment` in (34587, 26499);
...
#SALRAMM
(-1594129, 'You are too late, champion of Lordaeron. The dead shall have their day.', 'Cлишком поздно герои Лордерона! Пришло время мертвых...',0,1,0,0, '26499'),
(-1594130, 'Ah, the entertainment has arrived!', 'Аааааа развлечемся....',0,1,0,0, '26499'),
...
#ARTHAS - HOUSE
(-1594142, 'Heroes, hurry up, we\'ll meet near town hall. We must fight with Mal\'Ganis on its territory!', 'Герои, поспешите, вcтретимся у городской ратуши. Мы должны сразиться с Мал\'Ганисом на его территории!',14297,1,0,0, '26499'),
(-1594143, 'Follow me, I know the way.', 'Идите за мной я знаю дорогу.',14298,0,0,1, '26499'),
(-1594144, 'Ah, You\'ve finaly arrived, Prince Arthas. Youre here just in the nick of time.', 'Ах... Наконец вы прибыли, Принц Артас. Вы как раз во время.',0,0,0,1, '26499'),
(-1594145, 'Yes! I\'m glad to get here before plague!', 'Да! Я рад, что я смог добраться сюда раньше чумы!',14299,0,0,1, '26499'),
...
(-1594148, 'Seems that Mal\'Ganis has something else except Scourge. Let\'s hurry.', 'Кажется, что у Мал\'Ганиса в распоряжении есть еще кое что кроме Плети. Давайте поспешим.',14301,0,0,0, '26499'),
...
(-1594151, 'Be on the alert. We were surrounded.', 'Будьте начеку, наc окружили...',14304,0,0,0, '26499'),
...
(-1594157, 'Let\'s see, youg prince...', 'Ну что ж посмотрим юный принц...',13409,0,0,0, '26499'),
#Epoch
(-1594119, 'We\'ll see about that, young prince.', 'Аааааааа......',13416,0,0,0, '26499'),
...
#Street
(-1594158, 'It will take not much time.', 'Это займет совсем не много времени.',14310,0,0,0, '26499'),
