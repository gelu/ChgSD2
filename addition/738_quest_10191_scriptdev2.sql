...
(-1667594,'All systems on-line.  Prepare yourself, we leave shortly.',0,0,0,0,'max_a_million SAY_START'),
(-1667595,'Be careful in there and come back in one piece!',0,0,0,0,'bot-specialist_alley SAY_ALLEY_FAREWELL'),
(-1667596,'Proceed.',0,0,0,0,'max_a_million SAY_CONTINUE'),
(-1667597,'You\'re back!  Were you able to get all of the machines?',0,0,0,0,'bot-specialist_alley SAY_ALLEY_FINISH');
