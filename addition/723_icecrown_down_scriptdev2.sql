...
(-1594441, '<need translate>', 'Осторожней девочка! Однажды мне уже говорили что этот проклятый меч может нас спасти. Посмотри вокруг и ты увидешь что из этого вышло.', 16659,0,0,1, '67234'),
(-1594442, '<need translate>', 'Утер? Милый Утер! Мне... Мне так жаль.', 16635,0,0,1, '67234'),
(-1594443, '<need translate>', 'Утер? Утер Святоносный? Как...', 17052,0,0,1, '67234'),
...
(-1594477, '<need translate>', 'Твои союзники прибыли Джайна! Как ты и обещала... Хахахаха... Все вы станете могучими солдатами плети...', 17212,1,0,0, '67234'),
...
(-1594480, '<need translate>', 'Он слишком силен. Герои скорее, за мной. Мы должны выбраться от сюда немедленно. Я постараюсь его задержать пока мы будем убегать.', 17058,0,0,1, '67234'),
...
(-1594503, '<need translate>', 'Проклятый тупик, значит все закончится здесь. Готовтесь герои это наша последняя битва.', 17061,1,0,0, '67234'),
...
(-1594510, '<need translate>', 'Стратхольмские детишки и те сражались отчаянее!', 16712,1,0,0, '67234'),
...
(-1594514, '<need translate>', 'Эээээ... Да... Бегите на встречу судьбе. Ее жестокие и холодные обьятия ждут вас...', 16737,1,0,0, '67234'),
(-1594515, '<need translate>', 'У Теренаса был такой же взгляд в миг смерти, он никак не мог поверить... Хахахахаха...', 16735,1,0,0, '67234'),
...
#FrostWorn General
(-1594519, '<need translate>', 'Вы не достойны предстать перед Королем - Личом!', 16921,1,0,0, '67234'),
(-1594520, '<need translate>', 'Господин... Я подвел вас...', 16922,1,0,0, '67234'),

#add
(-1594531, '<need translate>', 'Ну, теперь точно пора сваливать.', 0,0,0,0, '67234'),
