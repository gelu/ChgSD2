...
UPDATE `creature_template` SET `ScriptName`='npc_sinclari', `npcflag`='1',`minhealth`='403200', `maxhealth`='403200', `attackpower`='1460' WHERE `entry`='30658'; -- 64
...
# UPDATE `creature_template` SET `npcflag`='1' WHERE `entry`='30659';
