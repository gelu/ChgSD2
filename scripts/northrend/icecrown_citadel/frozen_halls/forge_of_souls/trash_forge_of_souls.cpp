        ...
        if (SummonTimer < diff)
        {
                ...
                switch(Say)
                {
                  case 0:
                    ...
                    break;
                  case 1:
                    m_creature->MonsterSay("Dead hear my call!",LANG_UNIVERSAL,NULL);
                    break;
                  case 2:
                    m_creature->MonsterSay("I command power of Dead!",LANG_UNIVERSAL,NULL);
                    break;
                  case 3:
                    m_creature->MonsterSay("A raise my servant!",LANG_UNIVERSAL,NULL);
                    break;
                }
